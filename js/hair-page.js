const products = [
    { 
        id: 1, 
        category: "styler", 
        name: "NEW 에어랩 코안다 2x멀티 스타일러 앤 드라이어", 
    ...
    { 
        id: 16, 
        category: "essentials", 
        name: "키토산 프리 스타일 크림 스트레이트 투 웨이비 라이트 컨디셔닝 트래블 미니 30ml", 
...
function updateProductGrid(items) {
    container.innerHTML = items.map(item => {
        ...
        <article class="product-card">
            <a href="./product-hair-page.html?id=${item.id}" class="card-link">
